                    ...
                    <div class="subheader py-2 py-lg-6  subheader-transparent " id="kt_subheader">
                        <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                ...
                                <!--begin::Daterange-->
                                <a href="#" class="btn btn-bg-white font-weight-bold mr-3 my-2 my-lg-0" id="kt_dashboard_daterangepicker" data-toggle="tooltip" data-placement="left" style="pointer-events: none;">
                        ...
                        <div class=" container ">
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    ...
                                    <div class="card card-custom gutter-b card-stretch">
                                        ...
                                        <div class="card-header border-0 pt-5">
                                            <div class="card-title">
                                                <div class="card-label">
                                                    <div class="font-weight-bolder">Jumlah LHV IUP OPK Angkut Jual</div>
                                                    <div class="font-size-sm text-muted mt-2">
                                                    {{number_format((int)$total_lhv_trader,0,",",".")}}
                                                    Transaksi Tahun {{$datenow}}</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body d-flex flex-column px-0">
                                            <!--begin::Chart-->
                                            <div id="kt_tiles_widget_lhv_trader" data-color="info" style="height: 125px">
                                            </div>
                                            <!--end::Chart-->
                                            ...
                                            <div class="flex-grow-1 card-spacer-x">
                                                ...
                                                @foreach($surveyor_lhv_trader as $slt)
                                                    <!--begin::Item-->
                                                    <div class="d-flex align-items-center justify-content-between mb-10">
                                                        <div class="d-flex align-items-center mr-2">
                                                            <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                                <div class="symbol-label">
                                                                    <img src="{{asset('logo_surveyor/')}}/{{$slt->file}}" alt="" class="h-50" />
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <a href="#" class="font-size-h6 text-dark-75 text-hover-primary font-weight-bolder">{{$slt->name}}</a>
                                                                <div class="font-size-sm text-muted font-weight-bold mt-1">
                                                                    {{ str_limit($slt->alamat, 50) }}</div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="col-xl-5">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom bg-danger gutter-b" style="height: 130px">
                                                ...
                                                <div class="card-body d-flex flex-column p-0">
                                                    ...
                                                    <div class="flex-grow-1 card-spacer-x pt-6">
                                                        <div class="text-inverse-danger font-weight-bold">Pemasaran IUP OPK Angkut Jual (Ton)
                                                        </div>
                                                        <div class="text-inverse-danger font-weight-bolder font-size-h3">
                                                            {{ $total_pemasaran_bulan }}</div>
                                                    </div>
                                                    <!--end::Stats-->
                                            ...
                                            <div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b" style="height: 130px; background-image: url({{asset('assets/media/bg/bg-9.jpg')}})">
                                                <!--begin::Body-->
                                                <div class="card-body d-flex flex-column">
                                                    <!--begin::Title-->
                                                    <a href="#" class="text-dark-75 text-hover-primary font-weight-bolder font-size-h3">{{$total_pemasaran_bulan_transaksi}}</a>
                                                    Jumlah Transaksi Pemasaran IUP OPK Angkut Jual
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Body-->
                                            </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-custom gutter-b" style="height: 130px">
                                                ...
                                                <div class="card-body d-flex flex-column">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div class="text-dark-50 font-weight-bold">Pemasaran Trader ke Trader (Ton)</div>
                                                        <div class="font-weight-bolder font-size-h3">{{$total_pemasaran_trader}}</div>
                                                    </div>
                                                    <!--end::Stats-->
                                            ...
                                            <div class="card card-custom bg-info gutter-b" style="height: 130px">
                                                ...
                                                <div class="card-body d-flex flex-column p-0">
                                                    <!--begin::Stats-->
                                                    <div class="flex-grow-1 card-spacer-x pt-6">
                                                        <div class="text-inverse-info font-weight-bold">Pemasaran Trader ke Enduse (Ton)</div>
                                                        <div class="text-inverse-info font-weight-bolder font-size-h3">
                                                            {{$total_pemasaran_enduser}}</div>
                                                    </div>
                                                    <!--end::Stats-->
                                    ...
                                    <div class="card card-custom bgi-no-repeat gutter-b" style="height: 175px; background-color: #4AB58E; background-position: calc(100% + 1rem) bottom; background-size: 25% auto; background-image: url({{asset('assets/media/svg/humans/custom-1.svg')}})">
                                        <!--begin::Body-->
                                        <div class="card-body d-flex align-items-center">
                                            <div class="py-2">
                                                <h3 class="text-white font-weight-bolder mb-3">{{$surveyor}}</h3>
                                                <p class="text-white font-size-lg">
                                                    Jumlah Personil <br> Surveyor Semua Perusahaan yang Terdaftar
                                                </p>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="card card-custom bgi-no-repeat gutter-b card-stretch" style="background-color: #1B283F; background-position: 0 calc(100% + 0.5rem); background-size: 100% auto; background-image: url({{asset('assets/media/svg/patterns/rhone.svg')}})">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                            <div class="p-4">
                                                <h3 class="text-white font-weight-bolder my-7">Modul Verifikasi Pemasaran</h3>
                                                <p class="text-muted font-size-lg mb-7">
                                                    Jumlah <br>IUP OPK Angkut Jual yang Telah Terdaftar
                                                </p>
                                                <a href='#' class="btn btn-danger font-weight-bold px-6 py-3">{{$trader}}</a>
                                            </div>
                                        </div>
                                        <!--end::Body-->
                                    </div>
...
<script>
    ...
    $( document ).ready(function() {
        ...
        $('#dashboardmenu'). addClass('menu-item-active');
    });
</script>
<script>
    ...
    var KTWidgets = function() {
        ...
        var _initTilesWidget1 = function() {
            var element = document.getElementById("kt_tiles_widget_lhv_trader");
            var color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') : 'primary';
            var height = parseInt(KTUtil.css(element, 'height'));
            ...
            var options = {
                series: [{
                    name: 'JUMLAH LHV',
                    data: [{{$total_lhv_bulan1}},{{$total_lhv_bulan2}},{{$total_lhv_bulan3}},{{$total_lhv_bulan4}},{{$total_lhv_bulan5}},{{$total_lhv_bulan6}},{{$total_lhv_bulan7}},{{$total_lhv_bulan8}},{{$total_lhv_bulan9}},{{$total_lhv_bulan10}},{{$total_lhv_bulan11}},{{$total_lhv_bulan12}}]
                }],
                chart: {
                    type: 'area',
                    height: height,
        ...
        var _initTilesWidget2 = function() {
            ...
            var options = {
                series: [{
                    name: 'Pemasaran',
                    data: [{{$total_pemasaran_bulan1}},{{$total_pemasaran_bulan2}},{{$total_pemasaran_bulan3}},{{$total_pemasaran_bulan4}},{{$total_pemasaran_bulan5}},{{$total_pemasaran_bulan6}},{{$total_pemasaran_bulan7}},{{$total_pemasaran_bulan8}},{{$total_pemasaran_bulan9}},{{$total_pemasaran_bulan10}},{{$total_pemasaran_bulan11}},{{$total_pemasaran_bulan12}}]
                }],
                chart: {
                    type: 'area',
                    height: height,
        ...
        var _initTilesWidget5 = function() {
            ...
            var options = {
                series: [{
                    name: 'Transaksi',
                    data: [{{$total_pemasaran_end_bulan1}}, {{$total_pemasaran_end_bulan2}},{{$total_pemasaran_end_bulan3}},{{$total_pemasaran_end_bulan4}},{{$total_pemasaran_end_bulan5}},{{$total_pemasaran_end_bulan6}},{{$total_pemasaran_end_bulan7}},{{$total_pemasaran_end_bulan8}},{{$total_pemasaran_end_bulan9}},{{$total_pemasaran_end_bulan10}},{{$total_pemasaran_end_bulan11}},{{$total_pemasaran_end_bulan12}}]
                }, {
                    name: 'Transaksi',
                    data: [{{$total_pemasaran_end_bulan1}}, {{$total_pemasaran_end_bulan2}},{{$total_pemasaran_end_bulan3}},{{$total_pemasaran_end_bulan4}},{{$total_pemasaran_end_bulan5}},{{$total_pemasaran_end_bulan6}},{{$total_pemasaran_end_bulan7}},{{$total_pemasaran_end_bulan8}},{{$total_pemasaran_end_bulan9}},{{$total_pemasaran_end_bulan10}},{{$total_pemasaran_end_bulan11}},{{$total_pemasaran_end_bulan12}}]
                }],
