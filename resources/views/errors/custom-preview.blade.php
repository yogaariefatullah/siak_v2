...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        <!--begin::Error-->
        <div class="error error-3 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{asset('assets/media/error/bg5.jpg')}});">
            <!--begin::Content-->
            <div class="px-10 px-md-30 py-10 py-md-0 d-flex flex-column justify-content-md-center">
                <h1 class="error-title text-stroke text-dark"> Oops!  </h1>
                <p class="display-4 font-weight-boldest text-dark mb-12">
                LHV Tidak Di temukan
                </p>
                <p class="font-size-h1 font-weight-boldest text-dark-75">
                   Terjadi Kesalahan di sistem kami.
                </p>
                <p class="font-size-h4 line-height-md">
                   
                </p>
                <p class="font-size-h6 line-height-md">
