...
<script>
    ...
    $(function() {
        ...
        var table = $('#advancedDataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{route('traders.pembelian.mineral.data_pembelian')}}",
            columns: [{
                    data: "no",
                    name: "no",
                    width: "3%"
    ...
    function showDetail(id_pemasaran) {
        $('.body-content').show();
        $.ajax({
            url: "{{route('traders.pembelian.mineral.detail_pemasaran_perusahaan')}}",
            data: {
                id_pembelian_mn: id_pemasaran
            },
            beforeSend: function() {
                $('#detail').show();
            },
    ...
    function showtrader(id_pemasaran) {
        $('.body-content').show();
        $.ajax({
            url: "{{route('traders.pembelian.mineral.detail_pemasaran_trader')}}",
            data: {
                id_pembelian_mn: id_pemasaran
            },
            beforeSend: function() {
