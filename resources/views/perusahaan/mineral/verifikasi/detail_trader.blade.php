...
<div class="row">
    <div class="col-sm-7">
        ...
        <form id="btnVerif" method="GET">
            <a href="{{route('traders.verifikasi.batubara.accepted_trader', $item->id_pemasaran_bb)}}" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Diterima"><i class="fa fa-check-circle"></i>&nbsp;Diterima</a>&nbsp;
            <input type="hidden" name="id_pemasaran" id="id_pemasaran" value="{{$item->id_pemasaran_bb}}">
            <button type="submit" class="btn btn-danger js-submit-confirm-tolak_trader" data-toggle="tooltip" data-placement="bottom" title="Tolak"><i class="fa fa-times"></i>&nbsp;Ditolak</button>
        </form>
