...
<div class="modal fade bs-example-modal-lg" id="modal_verifikasi" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-xl ">
        <div class="modal-content">
            ...
            <form id="form_verif_tongkang" action="{{route('surveyors.tongkang.bb.accept')}}" method="post">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 control-label">Nama Tongkang</label>
                                    <div class="col-sm-9">
                                ...
                                <input type="hidden" class="form-control" autocomplete="off" name="id_pemasaran_bb" id="id_pemasaran_bb">
    ...
    function verifikasi_tongkang(data) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // $('#vol_cam').val(numberFormat(data[0].volume_pencampur, 4, ',', '.'));
