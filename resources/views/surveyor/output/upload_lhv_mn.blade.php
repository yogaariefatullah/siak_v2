            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card card-custom gutter-b" id="kt_card_3">
                        ...
                        <form class="form-horizontal" method="post" action="{{route('surveyors.store_dokumen_lhv.mn')}}" enctype="multipart/form-data" role="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Jenis Transportasi:</label>
                                            <div class="col-lg-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" name="customFile[]" accept=".pdf" id="customFile">
