...
<?php
$tmp_id_detail = ($id_detail) ? $id_detail : '-';
$aaa = 'https://mvp.esdm.go.id/laporan_lhv/' . base64_encode($id_pemasaran) . '/' . base64_encode($tmp_id_detail);
            ...
            <tbody>
                ...
                <tr>
                    <td align="left" style="width: 30%; height: 5%;">
                        ...
                        <img src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->merge('assets/logo.gif', 0.4, true)->size(500)->errorCorrection('H')->generate($aaa)) !!} " style="width: 4.0cm;">
                    </td>
                    <td align="left" style="width: 30%; height: 5%;">
