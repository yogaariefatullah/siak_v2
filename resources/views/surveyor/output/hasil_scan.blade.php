                        ...
                        <div class=" container ">
                            ...
                            <div class="card card-custom overflow-hidden">
                                <div class="card-body p-0">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="d-flex justify-content-between text-white pt-6">
                                                <div class="d-flex flex-column flex-root">
                                                    ...
                                                    @if($partial == '')
                                                    <span class="font-weight-boldest">{{$pemasaran[0]->no_lhv}}</span>
                                                    @else
                                                    <span class="font-weight-boldest">{{$partial[0]->no_lhv}}</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="font-weight-bold font-size-lg">
                                                            <td class="pl-0 pt-7">Total Muat : </td>
                                                        ...
                                                        @if($partial == '')
                                                        <tr class="font-weight-bold font-size-lg">
                                                            <td class="pl-0 pt-7">Total Volume : </td>
                                                            <td class="text-right pt-7 font-weight-boldest">
                                                                {{number_format($pm->total_volume,4,',','.')}} Ton
                                                            </td>
                                                        </tr>
                                                        @endif
                                                        @endforeach
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th class="pl-0 font-weight-bold text-muted text-uppercase">Laporan Transportasi</th>
                                                            <th></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        ...
                                                        <tr class="font-weight-bold font-size-lg">
                                                            <td class="pl-0 pt-7">Nama Tongkang : </td>
                                                            <td class="text-right pt-7 font-weight-boldest">{{$p->nama_tongkang}}</td>
                                                        </tr>
                                                        <tr class="font-weight-bold font-size-lg">
                                                            <td class="pl-0 pt-7">Nama Tug Boat : </td>
                                                            <td class="text-right pt-7 font-weight-boldest">{{$p->tag_boat}}</td>
                                                        </tr>
                                                        <tr class="font-weight-bold font-size-lg">
                                                            <td class="pl-0 pt-7">Total Muat : </td>
                                                            <td class="text-right pt-7 font-weight-boldest">{{number_format($p->volume,4,',','.')}} Ton</td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                                    ...
                                    <div class="row justify-content-center py-8 px-8 py-md-10 px-md-0">
                                        <div class="col-md-9">
                                            <span class="text-center text-muted text-uppercase">Sudah Terverifikasi</span>
                                        </div>
                                    </div>
                                    <!-- end: Invoice-->
                                </div>
