...
class RekapitulasiController extends Controller
{
    ...
    public function index()
    {
        ...
        $total = DB::table('inventori_trader')
            ->where('id_trader', $id_user)
            ->sum('volume');
        return view('perusahaan.batubara.rekapitulasi.index', compact('balance', 'data', 'total'));
    }
    ...
    public function detail_inventori($id_sk)
    {
        ...
        $datapembelian = DB::table('pembelian')->where('id_pembeli', $id_user)->where('id_penjual', $decode)->get();
        ...
        return view('perusahaan.batubara.rekapitulasi.detail', compact('datapembelian', 'getdatapemasaran', 'nama'));
    }
}
