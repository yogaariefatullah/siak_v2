...
class SkMineralController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('perusahaan.mineral.sk.index', $data);
    }
    ...
    public function detail_sk(Request $request)
    {
        ...
        return view('perusahaan.mineral.sk.detail', $data);
    }
    ...
    public function add_sk_page()
    {
        ...
        return view('perusahaan.mineral.sk.tambah_sk', $data);
    }
    ...
    public function perpanjang_sk_page()
    {
        ...
        return view('perusahaan.mineral.sk.perpanjang_sk', $data);
    }
    ...
    public function perusahaan_tambang()
    {
        ...
        $data = $db_2->table('perusahaan')->select('id_perusahaan', 'nama')
            ->where('tipe_perusahaan', 'b40a547d-dc5e-4bc0-b062-738f34e73922')
    ...
    public function store_sk(Request $request)
    {
        ...
        $no_SK = $request->no_sk;
        $tanggal_sk = reverse_default_date($request->tanggal_sk);
        $masa_berlaku = reverse_default_date($request->masa_berlaku);
        ...
        if ($insert > 0) {
            for ($i = 0; $i < $count; $i++) {
                ...
                $data = [
                    ...
                    'jenis_komoditas' => 'b40a547d-dc5e-4bc0-b062-738f34e73922',
        ...
        return redirect('traders/mineral/list-sk-mn');
    }
}
